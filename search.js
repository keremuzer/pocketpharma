...
setTimeout(() => {
  for (let i = 0; i < objects.length; i++) {
    let card = `        <div class="column">\n          <div class="card">\n            <div class="slider">\n              <div class="img-box">\n                <img src="img/Ventolin/antiyobik.png" class="slider-img">\n                <button class="btn prev" onclick="prev()"><i class="fa-solid fa-chevron-left"></i></button>\n                <button class="btn next" onclick="next()"><i class="fa-solid fa-chevron-right"></i></button>\n              </div>\n            </div>\n            <h3>${objects[i].ad}</h3>\n            <div class="buttons">\n              <a href="./video.html">VIDEO <i class="fa-solid fa-film"></i></a>\n              <a href="#">MORE INFO <i class="fa-regular fa-file-pdf"></i></a>\n              <a href="${objects[i].kt}" target="_blank">USER MANUAL <i class="fa-regular fa-file-pdf"></i></a>\n              <a href="${objects[i].küb}" target="_blank">KUB <i class="fa-regular fa-file-pdf"></i></a>\n            </div>\n            <div class="info">\n              <p>Brand: <b>${objects[i].firma}</b></p>\n              <p>Active Substances: <b>${objects[i].içerik}</b><p>\n            </div>\n          </div>\n        </div>`
...
function filterProducts() {
  ...
  objects.forEach(function(object) {
    ...
    let card = `        <div class="column">\n          <div class="card">\n            <div class="slider">\n              <div class="img-box">\n                <img src="img/Ventolin/antiyobik.png" class="slider-img">\n                <button class="btn prev" onclick="prev()"><i class="fa-solid fa-chevron-left"></i></button>\n                <button class="btn next" onclick="next()"><i class="fa-solid fa-chevron-right"></i></button>\n              </div>\n            </div>\n            <h3>${object.ad}</h3>\n            <div class="buttons">\n              <a href="./video.html">VIDEO <i class="fa-solid fa-film"></i></a>\n              <a href="#">MORE INFO <i class="fa-regular fa-file-pdf"></i></a>\n              <a href="${objects[i].kt}" target="_blank">USER MANUAL <i class="fa-regular fa-file-pdf"></i></a>\n              <a href="${object.küb}" target="_blank">KUB <i class="fa-regular fa-file-pdf"></i></a>\n            </div>\n            <div class="info">\n              <p>Brand: <b>${objects[i].firma}</b></p>\n              <p>Active Substances: <b>${object.içerik}</b><p>\n            </div>\n          </div>\n        </div>`
